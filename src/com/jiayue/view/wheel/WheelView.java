...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			int wheel_val = getResources().getIdentifier("wheel_val", "drawable", getContext().getPackageName());
		...
		int wheel_bg = getResources().getIdentifier("wheel_bg", "drawable", getContext().getPackageName());
