...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mCameraResolution = findCloselySize(ActivityUtils.getScreenWidth(mContext), ActivityUtils.getScreenHeight(mContext),
            parameters.getSupportedPreviewSizes());
        Log.e(TAG, "Setting preview size: " + mCameraResolution.width + "-" + mCameraResolution.height);
        mPictureResolution = findCloselySize(ActivityUtils.getScreenWidth(mContext),
        		ActivityUtils.getScreenHeight(mContext), parameters.getSupportedPictureSizes());
