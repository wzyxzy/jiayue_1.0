...
//     */
//    public void requestPreviewFrame(Handler handler, int code) {
//
//        try{
//            if (mCamera != null && mPreviewing) {
//                mPreviewCallback.setHandler(handler,code);
...
//     */
//    public void requestAutoFocus(Handler handler, int code) {
//        try{
//            if (mCamera != null && mPreviewing) {
//                // Log.d(TAG, "Requesting auto-focus callback");
//                mAutoFocusCallback.setHandler(handler,code);
