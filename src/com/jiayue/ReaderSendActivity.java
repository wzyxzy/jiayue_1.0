...
public class ReaderSendActivity extends BaseActivity {
	...
	private void loadData(String title, String content) {
		...
		DialogUtils.showMyDialog(ReaderSendActivity.this, MyPreferences.SHOW_PROGRESS_DIALOG, null, "正在发送中...", null);
		x.http().post(params, new Callback.CommonCallback<String>() {
			...
			public void onSuccess(String s) {
				...
				if (bean != null && bean.getCode().equals("SUCCESS")) {
					...
					DialogUtils.showMyDialog(ReaderSendActivity.this, MyPreferences.SHOW_ERROR_DIALOG, "获取失败", bean.getCodeInfo(), null);
				}
			}
