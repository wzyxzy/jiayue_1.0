...
public class AuthorReplyActivity extends BaseActivity {
	...
	private void loadData(String title, String content) {
		...
		DialogUtils.showMyDialog(AuthorReplyActivity.this, MyPreferences.SHOW_PROGRESS_DIALOG, null, "正在发送中...", null);
		x.http().post(params, new Callback.CommonCallback<String>() {
			...
			public void onSuccess(String s) {
				...
				if (bean != null && bean.getCode().equals("SUCCESS")) {
					ActivityUtils.showToastForSuccess(AuthorReplyActivity.this, "回复成功！");
					Intent intent = new Intent();
					intent.setAction("android.intent.action.author.reply");
					sendBroadcast(intent);
					finish();
				} else {
					DialogUtils.showMyDialog(AuthorReplyActivity.this, MyPreferences.SHOW_ERROR_DIALOG, "获取失败", bean.getCodeInfo(), null);
				}
			}
			...
			public void onError(Throwable throwable, boolean b) {
				DialogUtils.dismissMyDialog();
				ActivityUtils.showToast(AuthorReplyActivity.this, "信息获取失败，请检查网络");
			}
