package com.jiayue.chat.customer;
...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    private void updateVoiceView(){
        if (isHoldVoiceBtn){
            ...
            int btn_voice_pressed = getContext().getResources().getIdentifier("btn_voice_pressed", "drawable", getContext().getPackageName());
            voicePanel.setBackground(getResources().getDrawable(btn_voice_pressed));
            chatView.startSendVoice();
        }else{
            voicePanel.setText(getResources().getString(R.string.chat_press_talk));
            int btn_voice_normal = getContext().getResources().getIdentifier("btn_voice_normal", "drawable", getContext().getPackageName());
            voicePanel.setBackground(getResources().getDrawable(btn_voice_normal));
