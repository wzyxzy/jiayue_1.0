...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        int right_voice = context.getResources().getIdentifier("right_voice", "drawable", context.getPackageName());
        int left_voice = context.getResources().getIdentifier("left_voice", "drawable", context.getPackageName());
        voiceIcon.setBackgroundResource(message.isSelf()?right_voice: left_voice);
