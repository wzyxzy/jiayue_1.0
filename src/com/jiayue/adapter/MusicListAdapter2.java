...
public class MusicListAdapter2 extends WZYBaseAdapter<MusicList> {
    ...
    public MusicListAdapter2(List<MusicList> data, Context context, int layoutRes, boolean isChoose) {
...
//            music_num.setText("");
            ...
            music_num.setTextColor(0xff999999);
        }
        ...
        if (musicList.isPlaying()) {
            ...
            name_music.setTextColor(0xff333333);
            music_num.setTextColor(0xff999999);
        }
