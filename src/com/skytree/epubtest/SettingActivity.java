...
public class SettingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		doublePagedCheckBox = (CheckBox) this
				.findViewById(R.id.doublePagedCheckBox);
		lockRotationCheckBox = (CheckBox) this
				.findViewById(R.id.lockRotationCheckBox);
		globalPaginationCheckBox = (CheckBox) this
				.findViewById(R.id.globalPaginationCheckBox);
	...
	public void loadValues() {
		...
		if (index == 0)
			pageTransitionGroup.check(R.id.noneRadio);
		else if (index == 1)
			pageTransitionGroup.check(R.id.slideRadio);
		else
			pageTransitionGroup.check(R.id.curlRadio);
	...
	public void saveValues() {
		...
		int index = pageTransitionGroup
				.indexOfChild(findViewById(pageTransitionGroup
